...
const clsx$2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  clsx: clsx$1,
  default: clsx$1
}, Symbol.toStringTag, { value: "Module" }));
const require$$3$1 = /* @__PURE__ */ getAugmentedNamespace(clsx$2);
var utils$1 = {};
...
function childrenEqual(a, b) {
  return (0, _fastEquals$2.deepEqual)(_react$3.default.Children.map(a, (c) => c?.key), _react$3.default.Children.map(b, (c) => c?.key)) && (0, _fastEquals$2.deepEqual)(_react$3.default.Children.map(a, (c) => c?.props["data-grid"]), _react$3.default.Children.map(b, (c) => c?.props["data-grid"]));
}
...
function compact(layout, compactType2, cols, allowOverlap) {
  ...
  for (let i = 0, len = sorted.length; i < len; i++) {
    ...
    if (!l2.static) {
      l2 = compactItem(compareWith, l2, compactType2, cols, sorted, allowOverlap);
      compareWith.push(l2);
    }
...
function compactItem(compareWith, l2, compactType2, cols, fullLayout, allowOverlap) {
...
function moveElement(layout, l2, x2, y2, isUserAction, preventCollision, compactType2, cols, allowOverlap) {
  ...
  log$2(`Moving element ${l2.i} to [${String(x2)},${String(y2)}] from [${l2.x},${l2.y}]`);
  const oldX = l2.x;
  const oldY = l2.y;
  ...
  if (hasCollisions && allowOverlap) {
    ...
    log$2(`Collision prevented on ${l2.i}, reverting.`);
    l2.x = oldX;
    l2.y = oldY;
    l2.moved = false;
    return layout;
  ...
  for (let i = 0, len = collisions.length; i < len; i++) {
    ...
    log$2(`Resolving collision between ${l2.i} at [${l2.x},${l2.y}] and ${collision.i} at [${collision.x},${collision.y}]`);
...
function moveElementAwayFromCollision(layout, collidesWith, itemToMove, isUserAction, compactType2, cols) {
  ...
  if (isUserAction) {
    ...
    if (!firstCollision) {
      log$2(`Doing reverse collision on ${itemToMove.i} up to [${fakeItem.x},${fakeItem.y}].`);
      ...
      return moveElement(layout, itemToMove, void 0, collidesWith.y + 1, isUserAction, preventCollision, compactType2);
...
const resizeNorth = (currentSize, _ref, _containerWidth) => {
  ...
  const top = currentSize.top - (height2 - currentSize.height);
  return {
    left,
    width: width2,
    height: constrainHeight(top, currentSize.height, height2),
...
const resizeEast = (currentSize, _ref2, containerWidth) => {
  ...
  return {
    top,
    height: height2,
    width: constrainWidth(currentSize.left, currentSize.width, width2, containerWidth),
...
const resizeWest = (currentSize, _ref3, containerWidth) => {
  ...
  const left = currentSize.left - (width2 - currentSize.width);
  return {
    height: height2,
    width: left < 0 ? currentSize.width : constrainWidth(currentSize.left, currentSize.width, width2, containerWidth),
    top: constrainTop(top),
    left: constrainLeft(left)
  };
};
...
function calcWH(positionParams, width2, height2, x2, y2, handle) {
  const {
    margin,
    maxRows,
    cols,
  ...
  const colWidth = calcGridColWidth(positionParams);
  let w2 = Math.round((width2 + margin[0]) / (colWidth + margin[0]));
  let h = Math.round((height2 + margin[1]) / (rowHeight + margin[1]));
...
var _reactDom = _interopRequireDefault$8(reactDomExports);
var _domFns = domFns;
...
let DraggableCore$1 = class DraggableCore extends React$5.Component {
  constructor() {
    ...
    _defineProperty$7(this, "handleDragStart", (e) => {
    ...
    _defineProperty$7(this, "onMouseDown", (e) => {
      dragEventFor = eventsFor.mouse;
      return this.handleDragStart(e);
    });
    _defineProperty$7(this, "onMouseUp", (e) => {
      dragEventFor = eventsFor.mouse;
      return this.handleDragStop(e);
    });
    _defineProperty$7(this, "onTouchStart", (e) => {
      dragEventFor = eventsFor.touch;
      return this.handleDragStart(e);
    });
    _defineProperty$7(this, "onTouchEnd", (e) => {
      dragEventFor = eventsFor.touch;
      return this.handleDragStop(e);
    });
  }
...
(function(exports) {
  ...
  class Draggable2 extends React2.Component {
    ...
    render() {
      ...
      const className = (0, _clsx2.default)(children.props.className || "", defaultClassName, {
...
var resizableProps = {
  ...
  * */
  draggableOpts: _propTypes$6.default.shape({
    ...
    offsetParent: _propTypes$6.default.node,
  ...
  * */
  height: function height() {
    ...
    if (props.axis === "both" || props.axis === "y") {
      ...
      return (_PropTypes$number = _propTypes$6.default.number).isRequired.apply(_PropTypes$number, args);
    }
    return _propTypes$6.default.number.apply(_propTypes$6.default, args);
  },
  /*
  ...
  * */
  ...
  width: function width() {
    ...
    if (props.axis === "both" || props.axis === "x") {
      ...
      return (_PropTypes$number2 = _propTypes$6.default.number).isRequired.apply(_PropTypes$number2, args);
    }
    return _propTypes$6.default.number.apply(_propTypes$6.default, args);
  }
};
...
var Resizable = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.resizeHandler = function resizeHandler(handlerName, axis) {
    ...
    return function(e, _ref2) {
      ...
      var canDragX2 = (_this2.props.axis === "both" || _this2.props.axis === "x") && axis !== "n" && axis !== "s";
      var canDragY2 = (_this2.props.axis === "both" || _this2.props.axis === "y") && axis !== "e" && axis !== "w";
      ...
      var width2 = _this2.props.width + (canDragX2 ? deltaX / _this2.props.transformScale : 0);
      var height2 = _this2.props.height + (canDragY2 ? deltaY / _this2.props.transformScale : 0);
  ...
  _proto.render = function render() {
    ...
    var p2 = _objectWithoutPropertiesLoose$1(_this$props2, _excluded$1);
    return (0, _utils$4.cloneElement)(children, _objectSpread$1(_objectSpread$1({}, p2), {}, {
      className: (className ? className + " " : "") + "react-resizable",
      children: [].concat(children.props.children, resizeHandles.map(function(handleAxis) {
        var _this3$handleRefs$han;
        var ref = (_this3$handleRefs$han = _this3.handleRefs[handleAxis]) != null ? _this3$handleRefs$han : _this3.handleRefs[handleAxis] = /* @__PURE__ */ React$4.createRef();
...
var _clsx$2 = _interopRequireDefault$3(require$$3$1);
...
class GridItem extends _react.default.Component {
  constructor() {
    ...
    _defineProperty$3(this, "onDragStart", (e, _ref) => {
      let {
        node
      } = _ref;
      const {
    ...
    _defineProperty$3(this, "onDrag", (e, _ref2) => {
      ...
      if (isBounded) {
        ...
        if (offsetParent) {
          ...
          top = (0, _calculateUtils$1.clamp)(top - containerPadding[1], 0, bottomBoundary);
          ...
          left = (0, _calculateUtils$1.clamp)(left - containerPadding[0], 0, rightBoundary);
        }
      }
      const newPosition = {
        top,
    ...
    _defineProperty$3(this, "onResizeStop", (e, callbackData, position) => this.onResizeHandler(e, callbackData, position, "onResizeStop"));
    _defineProperty$3(this, "onResizeStart", (e, callbackData, position) => this.onResizeHandler(e, callbackData, position, "onResizeStart"));
    _defineProperty$3(this, "onResize", (e, callbackData, position) => this.onResizeHandler(e, callbackData, position, "onResize"));
  }
...
var _clsx$1 = _interopRequireDefault$2(require$$3$1);
...
function _interopRequireWildcard$2(e, r2) {
  ...
  for (var u2 in e) if ("default" !== u2 && Object.prototype.hasOwnProperty.call(e, u2)) {
    var i = a ? Object.getOwnPropertyDescriptor(e, u2) : null;
    i && (i.get || i.set) ? Object.defineProperty(n2, u2, i) : n2[u2] = e[u2];
  }
...
class ReactGridLayout extends React$2.Component {
  constructor() {
    ...
    _defineProperty$2(this, "onDragStart", (i, x2, y2, _ref) => {
      ...
      return this.props.onDragStart(layout, l2, l2, null, e, node);
    });
    _defineProperty$2(this, "onDrag", (i, x2, y2, _ref2) => {
      ...
      this.props.onDrag(layout, oldDragItem, l2, placeholder, e, node);
      this.setState({
    ...
    _defineProperty$2(this, "onResize", (i, w2, h, _ref5) => {
      ...
      const [newLayout, l2] = (0, _utils$2.withLayoutItem)(layout, i, (l3) => {
        ...
        if (preventCollision && !allowOverlap) {
          const collisions = (0, _utils$2.getAllCollisions)(layout, {
            ...l3,
            w: w2,
            h,
            x: x2,
      ...
      this.props.onResize(finalLayout, oldResizeItem, l2, placeholder, e, node);
      this.setState({
    ...
    _defineProperty$2(this, "onDragOver", (e) => {
      ...
      !e.nativeEvent.target?.classList.contains(layoutClassName$1)) {
        return false;
      }
      const {
        droppingItem,
...
function getBreakpointFromWidth(breakpoints, width2) {
  ...
  for (let i = 1, len = sorted.length; i < len; i++) {
    ...
    if (width2 > breakpoints[breakpointName]) matching = breakpointName;
  }
  return matching;
}
...
class ResponsiveReactGridLayout extends React$1.Component {
  ...
  generateInitialState() {
    ...
    const breakpoint = (0, _responsiveUtils.getBreakpointFromWidth)(breakpoints, width2);
...
var _clsx = _interopRequireDefault(require$$3$1);
...
const GridLayout = /* @__PURE__ */ getDefaultExportFromCjs(reactGridLayoutExports);
function useTime() {
...
function Clock() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "clock-continaer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "clock-date", children: formattedDate }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "clock-time", children: formattedTime })
  ] });
}
...
function Weather() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "weather-container", children: error ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "error-message", children: error }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: temperature !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "weather-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "weather-info", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "temperature", children: [
        Math.round(temperature),
        "°F"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "forecast", children: description })
    ] }),
    icon && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: icon, alt: "Weather icon", className: "weather-icon" })
  ] }) }) });
}
const InfoGrid = () => {
  const layoutConfig = [
    { i: "clock", x: 0, y: 0, w: 1, h: 1, static: true },
    // put da clock on the left
    { i: "weather", x: 1, y: 0, w: 1, h: 1, static: true }
  ...
  const gridProps = {
    ...
    rowHeight: 36,
    width: 398
    // width of grid based on padding
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(GridLayout, { ...gridProps, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, {}) }, "clock"),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Weather, {}) }, "weather")
  ] });
};
const BASE_EXP = 100;
const EXPONENT = 1.5;
...
const ProgressBar = ({ currentExp, level, page }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "progress-bar-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("progress", { value: currentExp, max: maxExp, className }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-text", children: `Level ${level}: ${Math.round(currentExp)}/${Math.round(maxExp)} EXP` })
  ] });
};
...
const PetIcon = ({ name, level, exp, page }) => {
  const [isJumping, setIsJumping] = reactExports.useState(false);
  let petImage;
  ...
  reactExports.useEffect(() => {
    if (isSharkieC) {
      const interval = setInterval(() => {
        setIsJumping(true);
        setTimeout(() => setIsJumping(false), 1e3);
      }, 8e3);
      return () => clearInterval(interval);
    }
  }, [isSharkieC]);
  const sizeClass = page === "Landing" ? "pet-large" : "pet-small";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `pet-container ${sizeClass}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pet-shadow" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "pet-name", children: name }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "pet-level", children: [
      "Level: ",
      level
    ] })
  ] });
...
const Button = ({ text, icon }) => {
  const [clickedOnce, setClickedOnce] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      onClick: handleClick,
      children: [
        icon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "button-icon", children: icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "button-text", children: text })
      ]
    }
  );
};
function Landing() {
  const [samplePet, setSamplePet] = reactExports.useState({
    name: "Sharkie",
    level: 13,
    // Example starting level
    exp: 600
    // Example starting EXP
  });
  const handleClick = () => {
    console.log("Button clicked!");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "total-margin", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Todogotchi" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "landing-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(InfoGrid, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { currentExp: samplePet.exp, level: samplePet.level, page: "Landing" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PetIcon,
        {
          name: samplePet.name,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          text: "To-Do List",
          onClick: handleClick,
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: ".././public/todo.svg", alt: "icon", style: { width: "20px", height: "20px" } })
        }
      )
    ] })
  ] });
...
createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Landing, {}) })
);
